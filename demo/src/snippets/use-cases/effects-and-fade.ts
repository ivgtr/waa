...
export const volumeControlFn = `import { createContext, ensureRunning, loadBuffer } from "waa-play/context";
...
export const stereoPanFn = `import { createContext, ensureRunning, loadBuffer } from "waa-play/context";
...
export const effectChainFn = `import { createContext, ensureRunning, loadBuffer } from "waa-play/context";
import {
  createGain,
  createBiquadFilter,
...
export const fadeInOutFn = `import { createContext, ensureRunning, loadBuffer } from "waa-play/context";
...
export const crossfadeFn = `import { createContext, ensureRunning, loadBuffer } from "waa-play/context";
import { createGain } from "waa-play/nodes";
import { play } from "waa-play/play";
